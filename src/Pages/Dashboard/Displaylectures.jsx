    ...
    return (
        <HomeLayout>
            <div className="flex flex-col gap-10 items-center justify-center min-h-[90vh] py-10 text-wihte mx-[5%]">
                <div className='flex flex-col justify-between items-center text-white text-4xl font-mono font-bold'>
                ...
                {(lectures && lectures.length > 0) ?
                    (<div className="flex justify-center gap-10 w-full">
                        ...
                        <ul className="w-[28rem] p-2 rounded-lg shadow-[0_0_10px_black] space-y-4 text-white">
